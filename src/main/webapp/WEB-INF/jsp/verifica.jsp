	...
	$(document).ready(function(){	
		$("#reservar").click(function(e){
			...
			$.ajax({
				...
				if(response == "redirect:/boasvindas")
					window.location.replace("${pageContext.request.contextPath}/boasvindas");
				else {
					...
					if(response.sucesso)
						...
						switch(response.erro){
							case "discente":
								swal(
									'Oops...',
									'É necessário ser discente para comprar refeições remanescentes!',
									'warning'
					        	)
					        	break;
							case "saldo":
