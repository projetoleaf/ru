		...
		<div class="col-sm-9">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="panel-title pull-left">Pesquisa por feriados</div>
					<div class="panel-title pull-right">
						<a href="adicionarFeriado">Novo feriado</a>
					</div>
				...
				<div class="panel-body">
						...
						<div class="col-lg-6">
							<div class="input-group">
								<input type="text" class="form-control" id="filtro"
									onkeyup="myFunction()"
									placeholder="Qual feriado você está procurando?"> <span
					...
					<table id="tabela" class="table table-bordered table-condensed texto mg-tp">
						<thead>
							<tr>
						...
						<c:forEach var="lista" items="${feriados}" varStatus="status">
							<tbody>
								<tr>
									<td class="text-center">${lista.id}</td>
									<td>${lista.data}</td>
									<td>${lista.descricao}</td>
									<td class="text-center"><a href="editarFeriado/${lista.id}"
										...
										<button
											...
											action="excluirFeriado/${lista.id}" method="post">
											<!-- Modal -->
												...
												<div class="modal-dialog">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Tem certeza que deseja excluir o feriado <b>${lista.descricao}</b>?
															</p>
														</div>
