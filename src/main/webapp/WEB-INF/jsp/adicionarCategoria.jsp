		...
		<div class="col-sm-9">
			<div class="panel panel-primary">
				<div class="panel-heading">
			        ...
			        <div class="panel-title pull-right"><a href="categoria">Voltar para a pesquisa</a></div>
			        <div class="clearfix"></div>
				</div>
				<div class="panel-body">					
					<form:form method="POST" action="incluirCategoria" modelAttribute="categoria" class="form-horizontal">
