		...
		<div class="col-sm-9">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="panel-title pull-left">Pesquisa por tipos</div>
					<div class="panel-title pull-right">
						<a href="adicionarTipo">Novo tipo</a>
					</div>
						...
						<div class="col-lg-6">
							<div class="input-group">
								<input type="text" class="form-control" id="filtro"
									onkeyup="myFunction()"
									placeholder="Qual tipo você está procurando?"> <span
						...
						<c:forEach var="lista" items="${tipos}" varStatus="status">
							<tbody>
								<tr>
									...
									<td class="text-center"><a href="editarTipo/${lista.id}"
										...
										<button
											...
											action="excluirTipo/${lista.id}" method="post">
											<!-- Modal -->
												...
												<div class="modal-dialog">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Tem certeza que deseja excluir o tipo <b>${lista.descricao}</b>?
															</p>
														</div>
