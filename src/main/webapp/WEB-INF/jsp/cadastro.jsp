				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"><span style="font-size: 16px;"
							class="glyphicon glyphicon-stats"></span> Relat?rios</span></a>
						<ul class="dropdown-menu forAnimate" role="menu">
							<li><a href="#"><span style="font-size: 16px;"
									...
									<div class="col-xs-10 col-sm-6">
										<div class="form-group">
											<label for="cpf">CPF:</label> <input type="text"
												class="form-control" id="cpf" placeholder="Apenas números" th:field="*{cpf}">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-xs-10 col-sm-6">
										<div class="form-group">
											<label for="email">Matricula:</label> <input type="text"
												class="form-control" id="nome"
												placeholder="Digite seu nome completo" th:field="*{matricula}">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-xs-10 col-sm-6">
										<div class="form-group">
											<label for="email">Data nascimento:</label> <input
												type="date" class="form-control" id="data-nasc" th:field="*{data-nasc}">
										</div>
									</div>
								</div>
