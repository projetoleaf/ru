	...
	<div class="row">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
			        ...
			        <div class="panel-title pull-right"><a href="/ru/manutencao/cursos/pesquisar">Voltar para a pesquisa</a></div>
			        <div class="clearfix"></div>
				</div>
				<div class="panel-body">
					<form:form method="POST" action="/ru/manutencao/cursos/salvar" class="form-horizontal">
						<form:hidden path="id" />
