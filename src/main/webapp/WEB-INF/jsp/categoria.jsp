		...
		<div class="col-sm-9">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="panel-title pull-left">Pesquisa por categorias</div>
					<div class="panel-title pull-right">
						<a href="adicionarCategoria">Nova categoria</a>
					</div>
						...
						<div class="col-lg-6">
							<div class="input-group">
								<input type="text" class="form-control" id="filtro"
									onkeyup="myFunction()"
									placeholder="Qual categoria você está procurando?"> <span
					...
					<table id="tabela"
						...
						<thead>
							<tr>
								...
								<th>Descrição</th>
								<th>Valor sem subsidio</th>
								<th>Valor com subsidio</th>
								<th class="col-btn"></th>
							</tr>
						</thead>

						<c:forEach var="lista" items="${categorias}" varStatus="status">
							<tbody>
								<tr>
									<td class="text-center">${lista.id}</td>
									<td>${lista.descricao}</td>
									<td>${lista.valor_sem_subsidio}</td>
									<td>${lista.valor_com_subsidio}</td>
									<td class="text-center"><a href="editarCategoria/${lista.id}"
										...
										<button
											...
											action="excluirCategoria/${lista.id}" method="post">
											<!-- Modal -->
												...
												<div class="modal-dialog">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<p>
																Tem certeza que deseja excluir a categoria <b>${lista.descricao}</b>?
															</p>
														</div>
