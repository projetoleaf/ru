...
public class ClienteController {
	...
	public String salvarClienteBiometria(Model model, @RequestParam("biometria") String biometria,
	...
	public String salvarClienteCategoria(Model model, @RequestParam("categoria") Long idCategoriaSelecionada,
			@RequestParam("id") Long id) {
